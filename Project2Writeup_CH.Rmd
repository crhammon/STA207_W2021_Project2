...
The goal of this analysis is to identify policies that affect vehicle fatalities, and ideally make suggestions to policy-makers. Because the data is observational without randomization of treatment, establishing causal relationships is exceedingly difficult. Using FE regression is likely the best option in this case because it eliminates the time-invariant characteristics inherent to each state. Thus, this model is appropriate because it is best able to account for the differences between states that are not controlled for explicitly .
